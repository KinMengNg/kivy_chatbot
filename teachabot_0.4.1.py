...
class ChatPage(GridLayout):
    def __init__(self, **kwargs):
        ...
        #self.adbutton = Button(text='AD SPACE', size=(350, 100))
        #self.add_widget(self.adbutton)

        self.adspace = Label(text='Ad Space', text_size=(350,120), halign="center", valign = "top")

...
class ChatPage(GridLayout):
    ...
    def interpret_message(self, message):
        ...
        elif message == '/backtrack':
            answer = '[Backtracking to last checkpoint...]'
            self.history.update_chat_history('{}'.format(answer))
